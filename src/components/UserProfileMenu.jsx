...
const UserProfileMenu = () => {
    ...
    return (
        <div className="relative" ref={menuRef}>
            ...
            {/* Dropdown Menu */}
            {isOpen && (
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-xl border border-slate-200 overflow-hidden z-[200] animate-in fade-in slide-in-from-top-2 duration-200">
                    {/* User Info Header */}
