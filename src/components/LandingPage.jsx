        ...
        <div className="w-full">
            ...
            <section className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                        {/* Prop 1 */}
                        <div className="group">
                            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-50 text-blue-600 mb-6 group-hover:scale-110 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300 shadow-sm">
                                <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                </svg>
                            </div>
                            <h3 className="text-xl font-bold text-slate-900 mb-3 tracking-tight">Dynamic Peer Groups</h3>
                        ...
                        <div className="group">
                            ...
                            <h3 className="text-xl font-bold text-slate-900 mb-3 tracking-tight">Real-Time Data Pipeline</h3>
                            <p className="text-slate-600 leading-relaxed">
                        ...
                        <div className="group">
                            ...
                            <h3 className="text-xl font-bold text-slate-900 mb-3 tracking-tight">AI Strategic Briefs</h3>
                            <p className="text-slate-600 leading-relaxed">
            ...
            <section className="bg-slate-50 py-20 border-t border-slate-200">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    <div className="inline-block px-4 py-1.5 rounded-full bg-indigo-100 text-indigo-700 font-bold text-xs uppercase tracking-widest mb-6">
                        Operational Benchmarks
                    </div>
                    <h2 className="text-3xl font-bold text-slate-900 mb-4 tracking-tight">Go Beyond Public Data</h2>
