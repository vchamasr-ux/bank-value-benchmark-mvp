...
<body>
    <div class="page-container">
        ...
        <!-- Footer -->
        <footer class="mt-12 pt-6 border-t border-slate-200 flex justify-between items-center text-xs text-slate-400">
            <div>Confidential & Proprietary - Generated by Bank Value Benchmark Platform</div>
            <button onclick="window.print()" class="no-print bg-slate-800 hover:bg-slate-900 text-white font-bold py-2 px-4 rounded shadow transition-colors">
                Print to PDF
            </button>
        </footer>
    </div>
